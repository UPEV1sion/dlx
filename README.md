...
To see examples of further processing see `solution_printer.py` in `pentomino_sols.py` and `n_queens_sols`, which output `.ppm` images and formated chessboards to `stdout` respectivly.

![example ppm](example.ppm)
